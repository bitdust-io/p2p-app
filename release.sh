...
(PYTHONIOENCODING=utf-8 VIRTUAL_ENV=1 ./venv/bin/buildozer -v --profile x86_64 android release || PYTHONIOENCODING=utf-8 VIRTUAL_ENV=1 ./venv/bin/buildozer -v --profile x86_64 android release)
...
rm -rfv ./bin/BitDustAndroid_unsigned.apk
rm -rfv ./bin/bitdust1-*-release-unsigned.apk
(PYTHONIOENCODING=utf-8 VIRTUAL_ENV=1 ./venv/bin/buildozer -v --profile armeabi_v7a android release || PYTHONIOENCODING=utf-8 VIRTUAL_ENV=1 ./venv/bin/buildozer -v --profile armeabi_v7a android release)
cp -v -f ./bin/bitdust*.apk ./bin/BitDustAndroid_unsigned.apk
mv -v -f buildozer.spec.building buildozer.spec
pw=$(cat ".keystore_password")
zipalign -v 4 ./bin/BitDustAndroid_unsigned.apk  ./bin/BitDustAndroid.apk
