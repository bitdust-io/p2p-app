...
class SinglePrivateFileScreen(screen.AppScreen):
    ...
    def on_downloading_progress(self, bytes_received, source_path, destination_path, remote_path, thread_id):
        if _Debug:
            print('SinglePrivateFileScreen.on_downloading_progress', bytes_received, source_path, destination_path, remote_path, thread_id)
    ...
    def on_uploading_progress(self, bytes_sent, source_path, destination_path, remote_path, thread_id):
        if _Debug:
            print('SinglePrivateFileScreen.on_uploading_progress', bytes_sent, source_path, destination_path, remote_path, thread_id)
