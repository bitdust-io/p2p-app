...
class SingleSharedFileScreen(screen.AppScreen):
    ...
    def on_download_file_button_clicked(self):
        if _Debug:
            print('SingleSharedFileScreen.on_download_file_button_clicked remote_path=%s' % self.remote_path)
    ...
    def on_file_download_result(self, resp):
        if _Debug:
            print('SingleSharedFileScreen.on_file_download_result', resp)
    ...
    def on_file_transfer_result(self, result):
        if _Debug:
            print('SingleSharedFileScreen.on_file_transfer_result', result)
        screen.main_window().state_file_transfering = False
